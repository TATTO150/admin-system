...
<?php endif; ?>
        ...
        <div class="mt-4 mb-4 text-m text-white dark:text-white text-center">
            <?php echo e(__('Gracias por registrarte con nosotros. Contacta con un adminitrador para que te conceda acceso al sistema y puedas iniciar sesión.')); ?>
        ...
        <form method="POST" action="<?php echo e(route('logout')); ?>" class="inline">
            ...
            <button type="submit" class="underline text-m text-white dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800 ms-2">
                <?php echo e(__('Volver al menu principal')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\carri\OneDrive\Escritorio\proyect\admin-system\resources\views/auth/autoregistro-notificacion.blade.php ENDPATH**/ ?>