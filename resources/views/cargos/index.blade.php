        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <a href="{{ route('cargos.crear') }}" class="btn btn-success">NUEVO</a>
                    <a href="{{ route('cargos.pdf') }}" class="btn btn-primary" target="_blank">REPORTE</a>
                </div>
                ...
                <table id="mitabla" class="table table-hover table-bordered">
                    ...
                    <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $cargo['COD_CARGO'] }}">
                                                <li><a class="dropdown-item" href="{{ route('cargos.edit', $cargo['COD_CARGO']) }}">EDITAR</a></li>
                                                <li>
                                                    <form action="{{ route('cargos.destroy', $cargo['COD_CARGO']) }}" method="POST" class="d-inline" onsubmit="return confirmDelete({{ $cargo['COD_CARGO'] }})">
                                                        @csrf
                                                        @method('DELETE')
                        ...
                        @else
                            <tr>
                                <td colspan="4" class="text-center">No se encontraron cargos.</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
...
$(document).ready(function() {
    ...
    <script>
        function confirmDelete(codCargo) {
            return Swal.fire({
                title: '¿Estás seguro?',
